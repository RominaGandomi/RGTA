...
namespace CryptionManager.Lib.Shared
{
    public class Check
    {
        internal Check()
        ...
        public class Argument
        {
            ...
            public static void IsNotEmpty(Guid argument, string argumentName)
            {
                ...
                {
                    throw new ArgumentException(string.Format("\"{0}\" Guid Can not be empty.", argumentName), argumentName);
                }
            }
            ...
            public static void IsNotEmpty(string argument, string argumentName)
            {
                ...
                {
                    throw new ArgumentException(string.Format("\"{0}\" Can not be empty.", argumentName), argumentName);
                }
            }
            ...
            public static void IsNotOutOfLength(string argument, int length, string argumentName)
            {
                ...
                {
                    throw new ArgumentException(string.Format("\"{0}\" Can not more than {1} characters.", argumentName, length), argumentName);
                }
            }
            ...
            {
                IsNotNull(argument, argumentName, "Collection can not be null");

                if (argument.Count == 0)
                {
                    throw new ArgumentException("Collection can not be empty.", argumentName);
                }
            }
